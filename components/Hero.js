    ...
    <main className="h-screen overflow-y-hidden">
      <div className="h-full relative">
        ...
        <div className="absolute w-full h-full flex flex-col items-center justify-center">
          ...
          >
            <h2 ref={headerText} className="font-sans invisible mx-4 md:mx-8 xl:mx-20 text-4xl md:text-6xl lg:text-7xl xl:text-9xl font-bold text-slate-50">
              SOFTWARE DEVELOPER
            </h2>
            <div> 
              <div></div>
            <p ref={secText} className="invisible font-body font-semibold mx-4 md:mx-8 xl:mx-20 text-slate-50 text-lg xl:text-2xl">
